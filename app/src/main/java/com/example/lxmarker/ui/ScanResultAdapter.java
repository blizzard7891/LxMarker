...
public class ScanResultAdapter extends BaseAdapter {
    ...
    public String cycleCmd = "";
    public String distCmd = "";
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView stats = (TextView) view.findViewById(R.id.status);

        Button distBtn = (Button) view.findViewById(R.id.btn_dist);
        final Button cycleBtn = (Button) view.findViewById(R.id.btn_cycle);
...
//        lastSeenView.setText(getTimeSinceString(mContext, scanResult.getTimestampNanos()));
        ...
        lastSeenView.setText(debugMessage);
        return view;
    }
